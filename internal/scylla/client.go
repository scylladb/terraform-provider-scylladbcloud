...
func (c *Client) deleteWithResponse(ctx context.Context, path string, resultType interface{}) error {
	return c.retryCall(ctx, http.MethodDelete, path, nil, resultType)
}
